...
/******/ 		return __webpack_require__.p + "" + ({"1":"posts","2":"album~posts","3":"album"}[chunkId]||chunkId) + ".bundle.js"
/******/ 	}
/******/
...
const render = () => {
  ...
  if (hash === '#posts') {
    ...
    Promise.all(/* import() | posts */[__webpack_require__.e(2), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, 1)).then(({ default: posts }) => {
      mainElement.appendChild(posts());
    })
  } else if (hash === '#album') {
    // mainElement.appendChild(album()); //旧版的方式，直接将数据添加到DOM中

    Promise.all(/* import() | album */[__webpack_require__.e(2), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, 9)).then(({ default: album }) => {
